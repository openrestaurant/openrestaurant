...
<div class="layout layout--menu--node">
  <?php if ($content['region_a']): ?>
    <div class="layout__region layout__region--region-a padding--sm--bottom border--sm--bottom">
  ...
  <?php if ($content['region_c']): ?>
    <div class="layout__region layout__region--region-c container padding--md--top padding--lg--bottom">
